 ...
 */
 ...
 //
 // secondSecond — собраны правила НЕ влияющие на количество знаков.
 ...
 */
 ...
 function firstStep(text) {
        ...
        text = text.replace(/([^\d])(\s?)(\.|\,|\:|\;|\!|\?)( ?)([^\.|\,|\:|\;|\!|\?|»|”|’| ])/g, "$1$3 $5");
        text = text.replace(/(\S)(\s?)(\.|\,|\:|\;|\!|\?)( ?)([^\.|\,|\:|\;|\!|\?|»|”|’|\d| ])/g, "$1$3 $5");
        text = text.replace(/(\S)(\s?)(\.|\,|\:|\;|\!|\?)[ ]?(\n|\r|)/g, "$1$3$4");
        text = text.replace(/(\S)(\s?)(\.|\,|\:|\;|\!|\?)$/g, "$1$3");
        text = text.replace(/(\S)(\s?)(\.|\,|\:|\;|\!|\?)[ ]+([^\.|\,|\:|\;|\!|\?|»|”|’])/g, "$1$3 $4");

        return text
    }

    function secondTypograf(text) {
